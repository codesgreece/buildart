...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -right-24 top-20 h-[50vh] w-[50vh] rounded-full opacity-40"
        style={{
          background:
      ...
      <div className="section-pad relative z-10 mx-auto grid max-w-[1400px] items-center gap-10 pb-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6 lg:pb-24 lg:pt-8">
        <div className="max-w-xl">
          ...
          <motion.h1
            ...
            className="font-display text-[clamp(3.5rem,12vw,8rem)] leading-[0.88] tracking-[-0.045em]"
          >
            BUILD
          ...
          <motion.p
            ...
            className="mt-6 font-display text-[clamp(1.6rem,3.5vw,2.6rem)] leading-[1.15] tracking-tight"
          >
            Από τα θεμέλια
            <br />
          ...
          >
            <MagneticLink href="#lyseis">Ανακάλυψε τις λύσεις</MagneticLink>
            <MagneticLink href="#epikoinonia" variant="ghost">
              Ζήτησε προσφορά
            </MagneticLink>
          </motion.div>
        </div>
      ...
      <div className="section-pad absolute inset-x-0 bottom-6 z-10 mx-auto flex max-w-[1400px] items-end justify-between">
        <p className="font-mono-arch text-[10px] tracking-[0.25em] uppercase text-[var(--ba-muted)]">
